                ...
                <div class="box filter">
                    ...
                    <div class="box-content">
                        ...
                        <div class="input-group date">
                            ...
                            <input value="@if($order['datestar'] != ''){{date('d-m-Y',$order['datestar'])}}@endif" type="text" name="datestar" data-beatpicker="true" data-beatpicker-format="['DD','MM','YYYY'],separator:'-'" data-beatpicker-position="['left','bottom']" data-beatpicker-disable="{from:[1970 , 2 , 2],to:[{{date("Y")}} , {{date("m")}}  , <?php echo (date("d") -1 ) ?> ]}"/>
                            </div><!-- date-row -->
                        </div>
